...
- 编译镜像, 根据平台来选择
  ...
  > - [x86 Dockerfile](./dockerfile/x86/Dockerfile)
...
- 启动容器
    ...
    ```
  > - [arm Dockerfile](./dockerfile/arm/Dockerfile)
  
  ```bash
  cd dockerfile/arm
  sudo docker build -t xinference_vacc:VVI-25.12.SP2_arm .
  ```
...
- 启动容器
    ...
    sudo docker run -it \
        ...
        --ipc=host \
        --network=host \
        xinference_vacc:VVI-25.12.SP2_arm bash
    ```
