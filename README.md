...
## LLM Models
- Deepseek-V3 系列  : [Deepseek-V3系列模型列表]（https://github.com/vastai/VastModelZOO/blob/develop/llm/deepseek_v3/README.md）  

- DeepSeek-R1系列  : [Deepseek-R1系列模型列表]
（https://github.com/Vastai/VastModelZOO/blob/develop/llm/deepseek_r1/README.md）

- Qwen3 系列 : [Qwen3系列模型列表]
...
- Qwen3系列 : [Qwen3系列模型列表](https://github.com/Vastai/VastModelZOO/blob/develop/llm/qwen3/vllm/README.md#%E6%A8%A1%E5%9E%8B%E6%94%AF%E6%8C%81)

## VLM Models
- MinerU2.5-2509-1.2B : [Mineru模型列表]（https://github.com/Vastai/MinerU/blob/main/README.md）

- Qwen3-VL系列  : [Qwen3-VL模型列表]
（https://github.com/vastai/VastModelZOO/blob/develop/vlm/qwen3_vl/README.md#%E6%A8%A1%E5%9E%8B%E6%94%AF%E6%8C%81）
