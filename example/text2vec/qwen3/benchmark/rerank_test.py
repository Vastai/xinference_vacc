...
class RerankBenchmark:
    def __init__(self, tei_url: str = "http://localhost:9996/v1/rerank", model_name: str = "Qwen3-Reranker-0.6B"):
        self.tei_url = tei_url
        self.model_name = model_name  # 新增模型名参数，适配不同rerank模型
        self.headers = {"Content-Type": "application/json"}
        self.tokenizer = AutoTokenizer.from_pretrained(f"/disk/models/Qwen3-Reranker-0.6B")
...
def main():
    ...
    tei_url = "http://localhost:9996/v1/rerank"
