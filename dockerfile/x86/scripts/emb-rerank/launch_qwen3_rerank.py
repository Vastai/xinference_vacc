...
def launch_qwen3_rerank_model(args: argparse, gpu_list:list[int]):
    base_url = args.url
    ...
    model_path = model_dict.get("model_path", "/weights/Qwen3-Reranker-0.6B")
...
if __name__ == '__main__':
    ...
    launch_qwen3_rerank_model(args,gpu_list)
