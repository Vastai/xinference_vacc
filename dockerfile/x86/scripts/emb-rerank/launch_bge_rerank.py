...
def launch_bge_rerank_model(args: argparse, gpu_list:list[int]):
    base_url = args.url
    ...
    model_path = model_dict.get("model_path", "/weights/bge-reranker-v2-m3")
...
if __name__ == '__main__':
    ...
    launch_bge_rerank_model(args,gpu_list)
