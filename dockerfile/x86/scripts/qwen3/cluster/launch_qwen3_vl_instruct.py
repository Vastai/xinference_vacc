...
def launch_qwen3vl_model(args: argparse):
    base_url = args.url
    ...
    model_path = model_dict.get("model_path", "/weights/Qwen3-VL-Instruct")
    model_uid = client.launch_model(
        model_name="Qwen3-VL-Instruct",
        model_uid="Qwen3-VL-Instruct",
        model_engine="vllm",
    ...
    print("launch Qwen3-VL-Instruct")
    print(model_uid)
